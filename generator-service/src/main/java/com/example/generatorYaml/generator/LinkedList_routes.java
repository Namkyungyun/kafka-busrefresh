...
public class LinkedList_routes {
    ...
    // Node 삽입 (중간에 삽입)
    public void insertNode(ListNode_routes preNode, String id, String uri, ArrayList<String> predicates,ArrayList<String> filters) {
        ListNode_routes newNode = new ListNode_routes(id,uri,predicates,filters);    // 새로운 노드 생성
    ...
    // Node 삽입 (마지막에 삽입)
    public void insertNode(String id,String uri,ArrayList<String> predicates,ArrayList<String> filters) {
        ListNode_routes newNode = new ListNode_routes(id,uri,predicates,filters);    // 새로운 노드 생성
        if(head == null) {
    ...
    public String return_str() {
        ...
        while(tempNode != null) {
            ...
            if(tempNode.getPredicates() == null){}
            else {
                result +="          predicates:\n";
            ...
            if(tempNode.getFilters() == null){}
            else {
                result += "          filters:\n";
                for (String filters : tempNode.getFilters()) {
                    result += "            - " + filters + "\n";
                }
            }
