...
import com.example.generatorYaml.generator.obj.Application;
...
public class Binding_yaml {
    ...
    public Binding_yaml(String uri){
        ...
        application = yaml_st.getSpring().getApplication();
        ...
        try {
            for(Routes input : routes){
                linkedList.insertNode(input.getId(),input.getUri(),input.getPredicates(),input.getFilters());
            }
        }catch (NullPointerException e){
            System.out.println("routers : " + e);
        }
...
//-------------------------------------------------------라우터-----------------------------------------------------------------
    ...
    //중간에 삽입
    public void insert_router(String preNode_id, String id, String uri, ArrayList<String> predicates,ArrayList<String> filters){
        ListNode_routes preNode = linkedList.searchNode(preNode_id);
        linkedList.insertNode(preNode,id,uri,predicates,filters);
    }

    //마지막에 삽입
    public void insert_router(String id,String uri,ArrayList<String> predicates,ArrayList<String> filters){
        linkedList.insertNode(id,uri,predicates,filters);
    }
...
//    }
    ...
    public void createYaml(String fileuri){
        ...
        try {
            ...
            if(linkedList_default_filters.getHead()==null){
                writer.write("");
            }else {
